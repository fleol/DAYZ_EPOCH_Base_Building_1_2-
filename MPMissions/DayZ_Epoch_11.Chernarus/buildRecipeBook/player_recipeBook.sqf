...
_recipeBook = [];
{
    ...
    _i =0;
    {
        _letters=["T","S","W","L","M","G","Go","Gb","Si","Po","Pw","Bl"];
        _qty="";
        _letter="";
        _qty_letter="";
        if (_x != 0) then {
...
"[TankTrap, SandBags, Wires, Logs, Scrap Metal, Grenades, Gold10z, Gold, Silver10oz, Pole, Plywood, Burlap]" hintC buildRecipeBook;
