...
if ((getPlayerUID player) in ["PLAYERUID1","PLAYERUID2"]) then { //making possible that every Player with ones of these UIDs can enter any Code and it will be valid
        if (typeOf(_panel) == "Infostand_2_EP1") then {
            _validMatch = true;
        } else {
...
*/ // <-- Delete this line to get it working, too!
